...
export declare class ObjectTemplate {
    ...
    static __dictionary__: {
        [key: string]: SupertypeConstructor;
    };
    ...
    static init(): void;
    static getTemplateByName(name: any): SupertypeConstructor;
    /**
    ...
    */
     ...
     * @private
     */
    static _setupFunction(_propertyName: any, propertyValue: any, ...args: any[]): any;
    /**
 * Purpose unknown
 *
