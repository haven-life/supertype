...
describe('Freeze Dried Arks', function () {
    ...
    it ('can log', function () {
        ...
        console.log(output);
        var result = '(foo="bar1")(permFoo="permBar1"foo="bar2")(foo="bar3")(permFoo="childFoo"foo="bar4")(foo="bar5")(foo="bar6"woopie={"yea":true,"oh":"' + date.toISOString() + '"})(foo="bar6"woopie={"yea":true,"oh":"' + date.toISOString() + '"})';
